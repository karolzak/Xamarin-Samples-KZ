...
namespace XamFormsHttpClient
{
    public static partial class OrdersExtensions
    {
        ...
        /// Reference to the XamFormsHttpClient.IOrders.
        /// </param>
        /// <param name='id'>
        /// Required.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<XamFormsHttpClient.Models.Order> result = await operations.DeleteOrderWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<XamFormsHttpClient.Models.Order> result = await operations.GetOrderWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<XamFormsHttpClient.Models.Order>> result = await operations.GetOrdersWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<XamFormsHttpClient.Models.Order> result = await operations.PostOrderWithOperationResponseAsync(order, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
