...
namespace Forms.Http
{
    public static partial class EmployeesExtensions
    {
        ...
        /// Reference to the Forms.Http.IEmployees.
        /// </param>
        /// <param name='id'>
        /// Required.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Forms.Http.Models.Employee> result = await operations.DeleteEmployeeWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Forms.Http.Models.Employee> result = await operations.GetEmployeeWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<Forms.Http.Models.Employee>> result = await operations.GetEmployeesWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Forms.Http.Models.Employee> result = await operations.PostEmployeeWithOperationResponseAsync(employee, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
