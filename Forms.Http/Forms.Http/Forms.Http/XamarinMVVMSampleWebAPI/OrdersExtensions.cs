...
namespace Forms.Http
{
    public static partial class OrdersExtensions
    {
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Forms.Http.Models.Order> result = await operations.DeleteOrderWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Forms.Http.Models.Order> result = await operations.PostOrderWithOperationResponseAsync(order, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
